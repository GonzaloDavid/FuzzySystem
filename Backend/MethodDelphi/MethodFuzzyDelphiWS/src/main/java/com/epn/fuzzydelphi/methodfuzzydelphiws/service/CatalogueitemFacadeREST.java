...
import com.epn.fuzzydelphi.methodfuzzydelphi.Catalogueitem;
import com.epn.fuzzydelphi.methodfuzzydelphi.CatalogueitemPK;
 ...
 */
@Stateless
@Path("com.epn.fuzzydelphi.methodfuzzydelphi.catalogueitem")
public class CatalogueitemFacadeREST extends AbstractFacade<Catalogueitem> {
    ...
    private CatalogueitemPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.epn.fuzzydelphi.methodfuzzydelphi.CatalogueitemPK key = new com.epn.fuzzydelphi.methodfuzzydelphi.CatalogueitemPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.epn.fuzzydelphi.methodfuzzydelphi.CatalogueitemPK key = getPrimaryKey(id);
