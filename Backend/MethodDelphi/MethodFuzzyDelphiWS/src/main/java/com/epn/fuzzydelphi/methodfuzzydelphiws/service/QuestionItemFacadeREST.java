...
import com.epn.fuzzydelphi.methodfuzzydelphi.QuestionItem;
 ...
 */
@Stateless
@Path("com.epn.fuzzydelphi.methodfuzzydelphi.questionitem")
public class QuestionItemFacadeREST extends AbstractFacade<QuestionItem> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, QuestionItem entity) {
        super.edit(entity);
    }
    ...
    public QuestionItem find(@PathParam("id") Long id) {
