...
public class QuestionsFacadeREST extends AbstractFacade<Questions> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Questions entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.epn.entities.QuestionsPK key = getPrimaryKey(id);
    ...
    public Questions find(@PathParam("id") PathSegment id) {
        com.epn.entities.QuestionsPK key = getPrimaryKey(id);
