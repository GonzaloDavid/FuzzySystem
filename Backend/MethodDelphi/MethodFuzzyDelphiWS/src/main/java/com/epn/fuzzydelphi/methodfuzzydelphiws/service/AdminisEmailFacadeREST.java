...
import com.epn.fuzzydelphi.methodfuzzydelphi.AdminisEmail;
import com.epn.fuzzydelphi.methodfuzzydelphi.AdminisEmailPK;
 ...
 */
@Stateless
@Path("com.epn.fuzzydelphi.methodfuzzydelphi.adminisemail")
public class AdminisEmailFacadeREST extends AbstractFacade<AdminisEmail> {
    ...
    private AdminisEmailPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.epn.fuzzydelphi.methodfuzzydelphi.AdminisEmailPK key = new com.epn.fuzzydelphi.methodfuzzydelphi.AdminisEmailPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.epn.fuzzydelphi.methodfuzzydelphi.AdminisEmailPK key = getPrimaryKey(id);
