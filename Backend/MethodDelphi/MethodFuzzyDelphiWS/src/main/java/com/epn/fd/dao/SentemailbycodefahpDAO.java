    ...
    public void sendquizbyfahp(String namesurvey, Person person,
        ...
        for (CatalogueItemContainer catalogueItemObj : catalogueItemList) {
            if (catalogueItemObj.getNameItem().equals("port")) {
                port = catalogueItemObj.getCatalogueitemPK().getCodeItem().trim();
            }
            if (catalogueItemObj.getNameItem().equals("emailDefault")) {
                emailDefault = catalogueItemObj.getCatalogueitemPK().getCodeItem().trim();
            }
            if (catalogueItemObj.getNameItem().equals("smtpHost")) {
                smtpHost = catalogueItemObj.getCatalogueitemPK().getCodeItem().trim();
            }
            if (catalogueItemObj.getNameItem().equals("password")) {
                password = catalogueItemObj.getCatalogueitemPK().getCodeItem().trim();
            }
        }
        try {
            String portAux = port;
