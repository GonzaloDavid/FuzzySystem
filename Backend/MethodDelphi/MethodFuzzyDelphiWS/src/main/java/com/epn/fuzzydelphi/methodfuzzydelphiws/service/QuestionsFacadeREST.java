...
import com.epn.fuzzydelphi.methodfuzzydelphi.Questions;
 ...
 */
@Stateless
@Path("com.epn.fuzzydelphi.methodfuzzydelphi.questions")
public class QuestionsFacadeREST extends AbstractFacade<Questions> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Questions entity) {
        super.edit(entity);
    }
    ...
    public Questions find(@PathParam("id") Long id) {
