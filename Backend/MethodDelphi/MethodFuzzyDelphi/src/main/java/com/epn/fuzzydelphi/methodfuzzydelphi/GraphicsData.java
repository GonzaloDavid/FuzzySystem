...
@NamedQueries({
    ...
    , @NamedQuery(name = "GraphicsData.findByCodeQuiz", query = "SELECT g FROM GraphicsData g WHERE g.codeQuiz = :codeQuiz")
...
public class GraphicsData implements Serializable {
    ...
    public GraphicsData(Long seqgraphicsdata, long codeQuiz, String xAxisvalues, String yAxisvalues, Date dateCreate, Date dateLastModify, long userCreate, long userLastModify) {
        this.seqgraphicsdata = seqgraphicsdata;
    ...
    public String toString() {
        return "com.epn.fuzzydelphi.methodfuzzydelphi.GraphicsData[ seqgraphicsdata=" + seqgraphicsdata + " ]";
    }
