...
@NamedQueries({
    ...
    , @NamedQuery(name = "AdminisEmail.findByStatusEmailCat", query = "SELECT a FROM AdminisEmail a WHERE a.statusEmailCat = :statusEmailCat")
    , @NamedQuery(name = "AdminisEmail.findByStatusEmail", query = "SELECT a FROM AdminisEmail a WHERE a.statusEmail = :statusEmail")
...
public class AdminisEmail implements Serializable {
    ...
    @Column(name = "statusEmailCat")
    private String statusEmailCat;
    ...
    public String getStatusEmailCat() {
        return statusEmailCat;
    }

    public void setStatusEmailCat(String statusEmailCat) {
        this.statusEmailCat = statusEmailCat;
    }
    ...
    public String toString() {
        return "com.epn.fuzzydelphi.methodfuzzydelphi.AdminisEmail[ adminisEmailPK=" + adminisEmailPK + " ]";
    }
