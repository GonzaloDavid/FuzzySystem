 ...
 */
@Embeddable
public class AttributesMatrixAverageValuePK implements Serializable {
    ...
    public AttributesMatrixAverageValuePK() {
    }

    public AttributesMatrixAverageValuePK(long codefahp, long codeCriteria, long codeQuiz, long codeQuestions, long itemLabel, long itemLabelCouple) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AttributesMatrixAverageValuePK)) {
            return false;
        }
        AttributesMatrixAverageValuePK other = (AttributesMatrixAverageValuePK) object;
    ...
    public String toString() {
        return "com.epn.entities.AttributesMatrixAverageValuePK[ codefahp=" + codefahp + ", codeCriteria=" + codeCriteria + ", codeQuiz=" + codeQuiz + ", codeQuestions=" + codeQuestions + ", itemLabel=" + itemLabel + ", itemLabelCouple=" + itemLabelCouple + " ]";
    }
