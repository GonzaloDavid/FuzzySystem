...
public class ItemQuestionMapperImpl implements ItemQuestionMapper {
    ...
    public ItemQuestionContainer sourceToDestination(QuestionItem source) {
        ...
        itemQuestionContainer.setCodeQuiz( source.getCodeQuestions().getCodeQuiz().getCodeQuiz() );

        itemQuestionContainer.setCodeQuestions( source.getCodeQuestions().getCodeQuestions() );
